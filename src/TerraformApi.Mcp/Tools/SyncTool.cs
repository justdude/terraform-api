...
public static class SyncTool
{
    ...
    public static async Task<string> Sync(
        ...
        [Description("Optional Terraform variable group name (e.g. 'my-api-group' or '${api_group_name}'). Defaults to the {api-group} placeholder tag.")] string? apiGroupName = null,
